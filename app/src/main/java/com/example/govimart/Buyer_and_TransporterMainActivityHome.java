...
public class Buyer_and_TransporterMainActivityHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_and__transporter_main_home);
...
/*        DocumentReference documentReference = fStore.collection("Users").document(U_ID);
        ...
        SearchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent( Buyer_and_TransporterMainActivityHome.this,SeachActivity.class);
                startActivity(i);
                finish();
            }
        });
            ...
            public void onItemSelected(int i) {
                ...
                switch (i){
                    case R.id.nav_messages:
                        intent = new Intent( Buyer_and_TransporterMainActivityHome.this,MessagesActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.nav_notifications:
                        intent = new Intent( Buyer_and_TransporterMainActivityHome.this,NotificationActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.nav_profile:
                        intent = new Intent( Buyer_and_TransporterMainActivityHome.this,ProfileActivity.class);
                        startActivity(intent);
                        break;
                }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_myDetails:
                ...
                Intent profile_intent = new Intent(Buyer_and_TransporterMainActivityHome.this,ProfileActivity.class);
                startActivity(profile_intent);
                break;
            case R.id.nav_logout:
                fAuth.signOut();

                Intent logout_intent = new Intent(Buyer_and_TransporterMainActivityHome.this, LogInActivity.class);
