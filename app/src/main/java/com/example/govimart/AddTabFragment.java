...
public class AddTabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.selectCategoryRecyclerView);
        ...
        mAdapter = new AddCategoryCardAdapter(mainCategoriesList, getActivity()); //mAdapter = new MainCategoryCardAdapter(getActivity(), mainCategoriesList);
